...
export const LAB_OBJECTS: LabObjectDef[] = [
  ...
  },
  {
    ...
    hitOffset: [0, 1.15, 0],
    camera: {
      desktop: { position: [2.2, 2.6, 3.4], target: [0.05, 1.2, 0.35] },
      mobile: { position: [1.6, 2.9, 4.2], target: [0.05, 1.25, 0.35] },
    },
    hoverAnim: "highlight",
    clickAnim: "pulse",
    placeholder: "geometry",
  },
  {
    ...
    hitOffset: [0, 0.95, 0],
    camera: {
      desktop: { position: [0.6, 2.2, 4.4], target: [-1.7, 1.1, 2.05] },
      mobile: { position: [0.9, 2.5, 5.1], target: [-1.7, 1.15, 2.05] },
    },
    hoverAnim: "scale",
    clickAnim: "pulse",
    placeholder: "geometry",
